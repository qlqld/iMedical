...
public class AgencyData {
	...
	@Column(name = "id")
	private Integer id;
	@Column(name = "agency_name",columnDefinition = "nvarchar(50)")
	private String agencyName;
	@Column(name = "agency_type",columnDefinition = "nvarchar(20)")
	private String agencyType;
	@Lob
	@Column(name = "agency_photo",columnDefinition = "varbinary(max)")
	private byte[] agencyPhoto;
	@Column(name = "agency_phone",columnDefinition = "nvarchar(20)")
	private String agencyPhone;
	@Column(name = "agency_address",columnDefinition = "nvarchar(50)")
	private String agencyAddress;
	@Column(name = "working_hours",columnDefinition = "nvarchar(20)")
	private String workingHours;
	@Column(name = "room_type",columnDefinition = "nvarchar(30)")
	private String roomType;
	@Column(name = "bed_number",columnDefinition = "smallint")
	private Integer bedNumber;
	@Column(name = "serve_target",columnDefinition = "nvarchar(50)")
	private String serveTarget;
	@Column(name = "government_subsidy",columnDefinition = "nvarchar(50)")
	private String governmentSubsidy;
	@Column(name = "medical_service",columnDefinition = "nvarchar(50)")
	private String medicalService;
	@Column(name = "professional_care",columnDefinition = "nvarchar(50)")
	private String professionalCare;
	@Column(name = "feature_service",columnDefinition = "nvarchar(50)")

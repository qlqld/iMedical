...
<img alt="圖片" src="${contextRoot}/img/header3.png" style="width: 30%;">
	...
	<div style="border: 4px solid; margin-left: 10%; margin-right: 10%; border-style: double; border-radius: 2em;">
	<h1 style=" margin-top: 20px; margin-bottom: 30px; font: 50px bold; text-align: center;">新增會員資料</h1>
	<div style="border: 4px solid;padding-left: 50px; padding-bottom: 50px; margin: 30px 30px 30px 30px; border-style: groove;  ">
